...
# model = 'gsim_cnn'
# model = 'CoSimGNN'
# model = 'CoSimGNN-global-mean'
model = 'CoSim-SAGPool'
# model = 'CoSim-DiffPool'
# model = 'CoSimGNN-Normal-Mean-Pool'
# model = 'CoSim-TopKPool'
# model = 'GCN-Mean'
# model = 'GCN-Max'
#model = 'CoSimGNN-cnn'
# model = 'CoSimGNN-Normal-Pool'
# model = 'CoSim-SimPool'
...
#     parser.add_argument(n, default=s)
    ...
    n = '--layer_{}'.format(c.c())
    s = 'Diff_Pooling:pool_type=topk,ratio={}'.format(6)
    parser.add_argument(n, default=s)
    ...
    n = '--layer_{}'.format(c.c())
    s = 'Diff_Pooling:pool_type=sag,ratio={}'.format(6)
    parser.add_argument(n, default=s)
...
elif model == 'CoSimGNN-Normal-Mean-Pool':
    n = '--layer_{}'.format(c.c())
    s = 'NodeEmbedding:type=gin,output_dim={},act=relu,bn=True'. \
        format(D)
    # D //= 2
    ...
    n = '--layer_{}'.format(c.c())
    s = 'Diff_Pooling:C={},N=None'.format(10)
    parser.add_argument(n, default=s)
...
elif model == 'CoSimGNN-Normal-Pool':
    n = '--layer_{}'.format(c.c())
    s = 'NodeEmbedding:type=gin,output_dim={},act=relu,bn=True'. \
        format(D)
    # D //= 2
    ...
    s = 'GMNLoss:ds_metric=cosine'
    parser.add_argument(n, default=s)
elif model == 'CoSimGNN-global-mean':
    ...
    n = '--layer_{}'.format(c.c())
    s = 'AVG_Pooling:input_dim={},end_pooling=False,max_pooling=False,global_pool=True'.format(D)
    parser.add_argument(n, default=s)

    more_nn = None  # 'EdgeConv'  # None, 'EdgeConv'

    n = '--layer_{}'.format(c.c())
    s = 'GMNEncoder:input_dim={},output_dim={},act=relu'.format(D,D)
    parser.add_argument(n, default=s)
...
validation = False  # TODO: tune this False before
...
load_model = None
# load_model = '/test/part/GraphMatching_submission/model/OurGED/logs/CoSim-SAGPool_training_iters_10000_dataset2_ER_100_2020-06-04T02-41-03.739842/trained_model_46.pt'
# load_model = '/test/part/GraphMatching_submission/model/OurGED/logs/CoSimGNN_training_iters_2000_dataset1_BA_100_2020-05-31T07-48-38.337627/trained_model_16.pt'
# load_model = '/test/part/GraphMatching_submission/model/OurGED/logs/CoSimGNN_training_iters_10000_dataset2_ER_100_2020-05-31T15-32-35.593326/trained_model_0.pt'
# load_model = '/test/out10/logs/CoSimGNN-MemPool_training_iters_5000_dataset1_BA_60_2020-05-11T02-42-33.582627/trained_model_8.pt'
# load_model = '/test/part/GraphMatching_submission/model/OurGED/logs/GMN_icml_mlp_gin_training_iters_5000_dataset1_BA_60_2020-05-26T23-52-26.066345/trained_model_2.pt'
# load_model = '/test/part/GraphMatching_submission/model/OurGED/logs/GMN_icml_mlp_gin_training_iters_5000_dataset1_BA_100_2020-05-23T19-34-12.742816/trained_model_5.pt'
# load_model = '/test/part/GraphMatching_submission/model/OurGED/logs/GMN_icml_mlp_gin_training_iters_10000_dataset2_ER_100_2020-05-26T01-46-32.421347/trained_model_36.pt'
# load_model = '/test/part/GraphMatching_submission/model/OurGED/logs/CoSim-SimPool_training_iters_10000_dataset2_ER_100_2020-05-25T00-45-13.438935/trained_model_87.pt'
#load_model = '/test/models/GCN-Max_training_iters_1000_dataset1_BA_60_2020-05-03T08-30-23.693186/trained_model_8.pt'
#load_model = '/test/part/GraphMatching_submission/model/OurGED/logs/CoSimGNN_training_iters_2000_dataset1_BA_100_2020-05-18T05-57-55.234382/trained_model_16.pt'
#load_model = '/test/out10/logs/CoSimGNN_training_iters_2000_dataset1_BA_100_2020-05-16T19-57-41.839496/trained_model_13.pt'
#load_model = '/test/part/GraphMatching_submission/model/OurGED/logs/CoSimGNN_training_iters_2000_dataset1_BA_200_2020-05-18T08-50-48.762982/trained_model_10.pt'
#load_model = '/test/part/GraphMatching_submission/model/OurGED/logs/CoSimGNN_training_iters_2000_dataset1_BA_100_2020-05-18T05-57-55.234382/trained_model_12.pt'
#load_model = '/test/part/GraphMatching_submission/model/OurGED/logs/CoSimGNN_training_iters_2000_dataset1_BA_60_2020-05-18T07-39-13.046245/trained_model_14.pt'
#load_model = '/test/part/GraphMatching_submission/model/OurGED/logs/CoSimGNN_training_iters_10000_dataset2_ER_100_2020-05-18T19-24-07.966578/trained_model_86.pt'
#load_model = '/test/part/GraphMatching_submission/model/OurGED/logs/GMN_icml_mlp_training_iters_10000_dataset1_BA_60_2020-05-17T22-22-32.472915/trained_model_23.pt'
#load_model = '/test/part/GraphMatching_submission/model/OurGED/logs/gsim_cnn_training_iters_10000_dataset1_BA_60_2020-05-17T20-18-06.201849/trained_model_25.pt'
#load_model = '/test/graphupup/cosimcnner100/trained_model_48.pt'
#load_model = '/test/models/CoSimGNN_training_iters_10000_dataset2_ER_100_2020-05-02T09-09-11.156602/trained_model_48.pt'
#load_model = '/test/models/GMN_icml_mlp_training_iters_10000_dataset2_ER_100_2020-04-30T22-27-11.957107/trained_model_88.pt'
#load_model = '/test/graph_up/GraphMatching_submission/model/OurGED/logs/GCN-Mean_training_iters_300_dataset2_ER_100_2020-05-03T07-25-49.096395/trained_model_0.pt'
#load_model = '/test/graph_up/GraphMatching_submission/model/OurGED/logs/GCN-Max_training_iters_300_dataset2_ER_100_2020-05-03T07-42-10.109693/trained_model_1.pt'
#load_model = '/test/graph_up/GraphMatching_submission/model/OurGED/logs/CoSimGNN-MemPool_training_iters_10000_dataset2_ER_100_2020-05-03T10-27-25.868782/trained_model_51.pt'
#load_model = '/test/graph_up/GraphMatching_submission/model/OurGED/logs/CoSimGNN-MemPool_training_iters_10000_dataset2_ER_100_2020-05-03T10-27-25.868782/trained_model_80.pt'
#load_model = '/test/graph_up/GraphMatching_submission/model/OurGED/logs/CoSimGNN-MemPool_training_iters_2000_dataset1_BA_200_2020-05-03T23-08-35.028298/trained_model_17.pt'
...
#load_model = '/test/graphupup/cosimcnnba200/trained_model_17.pt'
#load_model = '/test/part/GraphMatching_submission/model/OurGED/logs/gsim_cnn_training_iters_5000_dataset1_BA_60_2020-05-13T20-40-25.390108/trained_model_6.pt'
#load_model = '/test/models/CoSimGNN_training_iters_2000_dataset1_BA_200_2020-05-02T04-02-45.299293/trained_model_4.pt'
#load_model = '/test/models/gsim_cnn_training_iters_2000_dataset1_BA_200_2020-04-29T01-09-56.315274/trained_model_17.pt'
#load_model = '/test/graph_up/GraphMatching_submission/model/OurGED/logs/CoSimGNN-MemPool_training_iters_2000_dataset1_BA_60_2020-05-03T20-43-46.819864/trained_model_17.pt'
#load_model = '/test/graphupup/trained_model_17.pt'
#load_model = '/test/models/CoSimGNN_training_iters_2000_dataset1_BA_60_2020-05-01T22-44-03.898100/trained_model_13.pt'
#load_model = '/test/part/GraphMatching_submission/model/OurGED/logs/CoSimGNN_training_iters_2000_dataset1_BA_100_2020-05-12T20-38-06.312562/trained_model_10.pt'
#load_model = '/test/part/GraphMatching_submission/model/OurGED/logs/CoSimGNN-cnn_training_iters_2000_dataset1_BA_100_2020-05-13T01-25-02.477242/trained_model_13.pt'
