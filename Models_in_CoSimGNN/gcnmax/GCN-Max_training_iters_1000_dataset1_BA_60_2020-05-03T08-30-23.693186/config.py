...
if model == 'simgnn':
    ...
    s = 'NodeEmbedding:type=gin,input_dim={},output_dim={},act=prelu,bn=True'.format(D, D // 2)
    # D //= 2
    parser.add_argument(n, default=s)

    n = '--layer_{}'.format(c.c())
    # s = 'NodeEmbedding:type=gcn,input_dim={},output_dim={},act=relu,bn=False'.format(D // 2, D // 2 // 2)
    s = 'NodeEmbedding:type=gin,input_dim={},output_dim={},act=prelu,bn=True'.format(D // 2, D // 2 // 2)
    # D //= 2
    parser.add_argument(n, default=s)
...
load_model = None
#load_model = '/test/graph_up/GraphMatching_submission/model/OurGED/logs/GCN-Max_training_iters_500_dataset1_BA_60_2020-05-03T07-57-01.761092/trained_model_3.pt'
...
#load_model = '/test/graph_up/GraphMatching_submission/model/OurGED/logs/GCN-Mean_training_iters_300_dataset1_BA_200_2020-05-03T06-52-20.150625/trained_model_1.pt'
#load_model = '/test/graph_up/GraphMatching_submission/model/OurGED/logs/GCN-Mean_training_iters_500_dataset1_BA_100_2020-05-03T06-20-33.458594/trained_model_1.pt'
#load_model = "/Users/chenrj/Desktop/Graph_sim/GraphMatching_submission/model/OurGED/our_model/CoSimGNN_training_iters_2000_dataset1_BA_60_2020-05-01T20-26-14.878943/trained_model_17.pt"
