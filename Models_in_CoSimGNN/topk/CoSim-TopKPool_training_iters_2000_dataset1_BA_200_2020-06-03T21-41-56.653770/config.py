...
#     parser.add_argument(n, default=s)
    ...
    n = '--layer_{}'.format(c.c())
    s = 'Diff_Pooling:pool_type=topk,ratio={}'.format(20)
    parser.add_argument(n, default=s)
...
load_model = None
# load_model = '/test/part/GraphMatching_submission/model/OurGED/logs/CoSimGNN_training_iters_2000_dataset1_BA_200_2020-05-30T22-15-04.215845/trained_model_0.pt'
